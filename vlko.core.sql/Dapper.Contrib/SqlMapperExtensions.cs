...
namespace Dapper.Contrib.Extensions
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>Entity of T</returns>
        public static IEnumerable<T> GetMultiple<T>(this IDbConnection connection, IEnumerable<object> idList, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            var type = typeof(T);
...
#pragma warning restore CA2211 // Non-constant fields should not be visible
        ...
        /// <summary>
        /// Inspect entity to check if key property is specified.
        /// </summary>
        /// <typeparam name="T">The type to check.</typeparam>
        /// <param name="entityToCheck">Entity to check.</param>
        /// <returns>True if key property is set to non default value.</returns>
        public static bool IsKeySpecified<T>(T entityToCheck) where T : class
        {
            var type = typeof(T);
            ...
            if (keyProperties.Count() > 0)
            {
                ...
                {
                    var value = key.GetValue(entityToCheck);
                    if (IsDefault(value))
                    {
                        return false;
                    }
...
public partial interface ISqlAdapter
{
    ...
    /// <summary>
    /// Format column name to db specific format
    /// </summary>
    /// <param name="columnName">The column name.</param>
    /// <returns>Column name in db specific format.</returns>
